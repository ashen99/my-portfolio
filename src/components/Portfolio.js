...
const Portfolio = () => {
  ...
  return (
    <Section title={'Portfolio 🗒️'} 
    subtitle={'These are some of the projects that I have worked on. Some of them I have worked before I gained some experience. So go on gentle on them.'}
    >
